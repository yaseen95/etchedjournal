...
// Copy pasted from
// https://github.com/cam-inc/camflake/blob/develop/camflake/src/main/java/com/camobile/camflake/Camflake.java

// Has been modified to remove log statements
...
public final class Camflake {
    ...
    public long next() {
        ...
        return (elapsed << 22) | (sequence << 16) | machineId;
    }
