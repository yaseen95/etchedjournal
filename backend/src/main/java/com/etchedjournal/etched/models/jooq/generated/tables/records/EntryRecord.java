...
public class EntryRecord extends UpdatableRecordImpl<EntryRecord> implements Record9<String, Instant, byte[], String, OwnerType, String, String, Integer, String> {

    private static final long serialVersionUID = -1227094170;
     ...
     */
    public EntryRecord setSchema(String value) {
        set(8, value);
        return this;
    }
     ...
     */
    @Override
    public Row9<String, Instant, byte[], String, OwnerType, String, String, Integer, String> fieldsRow() {
     ...
     */
    @Override
    public Row9<String, Instant, byte[], String, OwnerType, String, String, Integer, String> valuesRow() {
     ...
     */
    @Override
    public EntryRecord value9(String value) {
        setSchema(value);
        return this;
    }
     ...
     */
    @Override
    public EntryRecord values(String value1, Instant value2, byte[] value3, String value4, OwnerType value5, String value6, String value7, Integer value8, String value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public EntryRecord(String id, Instant timestamp, byte[] content, String owner, OwnerType ownerType, String journalId, String keyPairId, Integer version, String schema) {
        super(Entry.ENTRY);
