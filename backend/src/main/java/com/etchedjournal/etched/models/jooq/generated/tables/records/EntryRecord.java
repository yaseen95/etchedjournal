...
public class EntryRecord extends UpdatableRecordImpl<EntryRecord> implements Record9<String, Instant, byte[], String, OwnerType, String, String, Integer, Schema> {

    private static final long serialVersionUID = -1497173447;
     ...
     */
    @Override
    public EntryRecord value9(Schema value) {
        setSchema(value);
        return this;
    }
     ...
     */
    @Override
    public EntryRecord values(String value1, Instant value2, byte[] value3, String value4, OwnerType value5, String value6, String value7, Integer value8, Schema value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public EntryRecord(String id, Instant timestamp, byte[] content, String owner, OwnerType ownerType, String journalId, String keyPairId, Integer version, Schema schema) {
        super(Entry.ENTRY);
