...
public class JournalRecord extends UpdatableRecordImpl<JournalRecord> implements Record8<String, Instant, byte[], String, OwnerType, String, Integer, Schema> {

    private static final long serialVersionUID = 556125517;
     ...
     */
    @Override
    public Row8<String, Instant, byte[], String, OwnerType, String, Integer, Schema> fieldsRow() {
     ...
     */
    @Override
    public Row8<String, Instant, byte[], String, OwnerType, String, Integer, Schema> valuesRow() {
     ...
     */
    @Override
    public JournalRecord value8(Schema value) {
        setSchema(value);
        return this;
    }
     ...
     */
    @Override
    public JournalRecord values(String value1, Instant value2, byte[] value3, String value4, OwnerType value5, String value6, Integer value7, Schema value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JournalRecord(String id, Instant timestamp, byte[] content, String owner, OwnerType ownerType, String keyPairId, Integer version, Schema schema) {
        super(Journal.JOURNAL);
